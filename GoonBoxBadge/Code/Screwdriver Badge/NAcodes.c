...
// These codes have been heavily modified to work with the Goon Box Badge Screwdriver!
// You can find the original here: https://learn.adafruit.com/tv-b-gone-kit/
...
/*const PGM_P * const powerCodes[] PROGMEM  = {
...
//These are the codes that fit in available program space
const PGM_P * const powerCodes[] PROGMEM  = {
	&sonyCode, &rcaCode, &panasonicCode, &sharpCode, &toshibaCode,
	&philipsCode, &samsungCode, &zenithCode, &pioneerCode, &sylvaniaCode,
	&jvcCode, &hitachiCode, &sampoCode, &hisenseCode, &viewsonicCode,
	&bushCode, &aocCode, &bellCode, &pioneer2Code, &fujitsuCode,
	&goldstarCode, &daewooCode, &NECCode, &admiralCode
};
